...
from app.schemas.auth import RefreshTokenRequest, TokenData, TokenSchema
...
async def refresh_access_token(
    ...
    refresh_status = await redis_connection.get(f"refresh:{payload.refresh_token}")
...
async def register(
    ...
    await mongo.create_model_config(
        ...
        model_url=settings.deepseek_base_url,
        api_key=settings.deepseek_api_key or "sk-default-xxx",
        base_used=[],
