  ...
  return (
    <div className="relative flex justify-center items-center h-[300px] w-[300px]">
        <div className="flex flex-col items-center">
          {/* 加载圈 */}
          <div className="w-10 h-10 border-4 border-gray-300 border-t-[var(--rag-brand)] rounded-full animate-spin"></div>
          
          {/* 进度条 */}
          <div className="w-3/4 bg-gray-300 rounded-full h-2 mt-4">
            <div
              className="bg-[var(--rag-brand)] h-full rounded-full transition-all duration-300 ease-in-out"
