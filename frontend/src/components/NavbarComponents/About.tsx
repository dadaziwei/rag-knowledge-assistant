...
const About: React.FC<AboutProps> = ({ onCancel }) => {
          ...
          <div className="h-full p-2 overflow-y-auto">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="rounded-2xl shadow-lg w-full mb-2 p-4 bg-gray-100">
                <p className="break-words font-mono text-sm px-4">
                  {t("thankYouContent")}
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="rounded-2xl shadow-lg w-full mb-2 p-4 bg-gray-100">
                ...
                >
                  https://github.com/daziwei/daziknow
                </a>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="rounded-2xl shadow-lg flex flex-col gap-1 w-full mb-2 p-4 bg-gray-100">
                ...
                >
                  {t("githubProfile")}: https://github.com/daziwei
                </a>
                <p className="whitespace-pre-wrap font-mono text-sm px-4">
                  {t("email")}: daziwei@example.com
                </p>
              </div>
            </div>
